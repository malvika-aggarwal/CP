angular.module('privacynoticeCtrl', [])
    .controller('privacyNoticeController', ['$scope', '$http', 'Notification', '$sce', '$location', function ($scope, $http, Notification, $sce, $location) {
        ...
        $scope.saveSection = function () {
            ...
            $http.post('/savePrivacyNotice', data).then((data) => {
        ...
        $scope.careerSupportInit = function () {
            ...
            $http.get('/getSectionsForPrivacyNotice').then((sections) => {
        ...
        $scope.updateSection = function () {
            ...
            $http.put(`/updateSectionPrivacyNotice/${$scope.sectionData._id}`, $scope.sectionData).then(() => {
        ...
        $scope.privacynoticeUserInit = function () {
            $http.get(`/getPrivacyNoticeListing?lang=${$scope.currentLanguage}`).then((data) => {
